...
| -------------------------------------------------------------------*/
	...
	//$config['img_path'] = '/apasionados.chile.travel/application/archivos/banners/contenidos'; // Relative to domain name
	//$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
	
	require_once("../../../../../../../config/constants.php");
	$config['img_path'] = TINYMCE_FULL_PATH;
	$config['upload_path'] = TINYMCE_UPLOADS_PATH;
