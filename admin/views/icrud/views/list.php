<?php
	$this->set_css('admin/views/icrud/css/fineuploader.css');
	$this->set_css('admin/views/icrud/css/photogallery.css');
	$this->set_css('admin/views/icrud/css/colorbox.css');

	$this->set_js('admin/views/icrud/js/jquery-1.8.2.min.js');
	$this->set_js('admin/views/icrud/js/jquery-ui-1.9.0.custom.min.js');

	$this->set_js('admin/views/icrud/js/fineuploader-3.2.min.js');
	
	$this->set_js('admin/views/icrud/js/jquery.colorbox-min.js');
?>
<script>
$(function(){
	<?php if ( ! $unset_upload) {?>
