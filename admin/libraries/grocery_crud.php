...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $default_language_path				= 'admin/views/gcrud/languages';
	protected $default_config_path					= 'admin/views/gcrud/config';
	protected $default_assets_path					= 'admin/views/gcrud';
