...
class image_CRUD {
	...
	protected $relation_parent_field = null;
	protected $relation_parent_value = null;
	...
	protected $default_language_path = 'admin/views/icrud/languages';
	...
	/** CHaack - Se registra nuevo metodo para relacionar las imagenes */
	function set_relation_parent($field_name, $value) {
		$this->relation_parent_field = $field_name;
		$this->relation_parent_value = $value;
	...
	protected function _library_view($view, $vars = array(), $return = FALSE)
	{
		...
		$view_file = 'admin/views/icrud/views/';
    ...
    protected function _insert_table($file_name, $relation_id = null)
    {
    	...
    	if(!empty($this->relation_parent_value) && !empty($this->relation_parent_field)) {
    		$insert[$this->relation_parent_field] = $this->relation_parent_value;
    	}
	...
	{
		include('admin/views/icrud/config/translit_chars.php');
